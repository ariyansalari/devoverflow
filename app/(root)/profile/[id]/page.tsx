...
<div className='mt-3'>
    ...
    <p className='paragraph-regular text-dark-200_ligth800'>@{userInfo.user.username}</p>
...
<div className='flex justify-end max-sm:mb-5 max-sm:w-full sm:mt-3 '>
    ...
    <Stats totalQuestions={userInfo.totalQuestions} totalAnswer={userInfo.totalAnswers} badge={userInfo.badgeCounts} reputation={userInfo.reputation}/>
